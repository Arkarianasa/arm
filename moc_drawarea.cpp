...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DrawArea_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 74, 16)
    ...
    "DrawArea\0trackChanged\0\0clearImage\0"
    "drawPoints\0checkColision\0point\0distance\0"
    "checkOutOfBounce\0"
};
...
static const uint qt_meta_data_DrawArea[] = {
 ...
 // slots: parameters
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::Bool, QMetaType::QPoint, QMetaType::Int,    6,    7,
    QMetaType::Bool,
...
void DrawArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->drawPoints(); break;
        case 3: { bool _r = _t->checkColision((*reinterpret_cast< const QPoint(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 4: { bool _r = _t->checkOutOfBounce();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        default: ;
        }
        ...
        {
            typedef void (DrawArea::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DrawArea::trackChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DrawArea::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DrawArea.data,
      qt_meta_data_DrawArea,  qt_static_metacall, 0, 0}
};
